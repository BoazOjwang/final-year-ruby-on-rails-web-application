...
class TestimonialsControllerTest < ActionDispatch::IntegrationTest
  ...
  test 'should create testimonial' do
    assert_difference('Testimonial.count') do
      post testimonials_url, params: { testimonial: { comment: @testimonial.comment, name: @testimonial.name } }
    end
  ...
  test 'should update testimonial' do
    patch testimonial_url(@testimonial),
          params: { testimonial: { comment: @testimonial.comment, name: @testimonial.name } }
